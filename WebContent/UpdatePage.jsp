...
LinkedList<getList> lstType=objdh.getTableList(strMenuId);
%>
	...
	<div class="bg-contact100" style="background-image: url('img/update-01.jpg');">
		<div class="container-contact100">
			<div class="wrap-contact100">
				...
				<form class="contact100-form validate-form" action="RestMenuServlet">  
				
					<span class="contact100-form-title">
						Update Menu
					</span>
					
					<input type="hidden" name="rid" value="<%=strRestId%>">
					<div class="wrap-input100 validate-input col">
						<input class="input100" type="text" name="txtMid" value="<%=strMenuId %>" readonly>
						<span class="tooltiptext">Menu ID</span>
...
<%
for(getList gl:lstType)
{
%>
					<div class="wrap-input100 validate-input col">
						<input class="input100" type="text" name="txtType" value="<%=gl.getStrMenuType() %>" readonly>
					...
					<div class="wrap-input100 validate-input col" data-validate = "Name is required">
						<input class="input100" type="text" name="txtName" value="<%=gl.getStrMenuName() %>">
					...
					<div class="wrap-input100 col">
						<textarea class="input100" type="text" name="txtDesc" placeholder="Enter Description(Optional)"><%=gl.getStrMenuDesc()%></textarea>
					...
					<div class="wrap-input100 validate-input col" data-validate = "Veg/Non-Veg">
						<input class="input100" type="text" name="txtClass" value="<%=gl.getStrMenuclass() %>">
					...
					<div class="wrap-input100 validate-input col" data-validate = "price is required">
						<input class="input100" type="text" name="txtPrice" value="<%=gl.getStrMenuPrice() %>">
