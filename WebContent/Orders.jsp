...
LinkedList<getRestOrders> lst=objDH.getTableRestOrders(strRestId);
				...
				<div class="table100 ver1 m-b-110">
					...
					<div class="table100-body js-pscroll">
						<table>
							...
							<tbody>
							<%
							for(getRestOrders ro:lst)
							{
							%>
							
								<tr class="row100 body">
									<td class="cell100 column1"><%=ro.getStrBillNo() %></td>
									<td class="cell100 column2"><%=ro.getStrUName() %></td>
									<td class="cell100 column3"><%=ro.getStrMenuId() %></td>
									<td class="cell100 column4"><%=ro.getStrMenuName() %></td>
									<td class="cell100 column5"><%=ro.getStrMenuPrice() %></td>
									<td class="cell100 column6"><%=ro.getStrQty() %></td>
									<td class="cell100 column7">
											<div class="btn-group">
												   
												 <a href="OMServlet?billno=<%=ro.getStrBillNo()%>&mid=<%=ro.getStrMenuId() %> "   <button type="button" class="btn btn-success btn-sm button1"><i class="fa fa-check-square-o" style="font-size:15px"></i>Complete</button>></a>
