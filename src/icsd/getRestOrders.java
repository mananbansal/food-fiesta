...
public class getRestOrders {
	
	public getRestOrders()
	{
	...
	public getRestOrders(String strMenuId, String strMenuName, String strBillNo, String strMenuPrice, String strUName,
			String strQty) {
		super();
	...
	public String toString() {
		return "getRestOrders [strMenuId=" + strMenuId + ", strMenuName=" + strMenuName + ", strBillNo=" + strBillNo
